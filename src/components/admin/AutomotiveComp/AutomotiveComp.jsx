            ...
            <Col md={3} className="bg-light p-3">
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Check type="checkbox" label="Toyota" />
                  <Form.Check type="checkbox" label="Mercedez-Benz" />
                  <Form.Check type="checkbox" label="Nissan" />
                  <Form.Check type="checkbox" label="BMW" />
                  <Form.Check type="checkbox" label="Lamborghini" />
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" placeholder="Downtown Dubai" />
                </Form.Group>
                  ...
                  <Row className="g-0">
                    ...
                    <Col md={8}>
                      <Card.Body>
                        ...
                        <Card.Text>
                          <small className="text-muted">Dubai</small>
                          <br />
                          <small className="text-muted">
                            2022 | 6,000 Km | Petrol | Automatic
                          </small>
                          <br />
