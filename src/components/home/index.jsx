  ...
  return (
    <>
      <div className="main-wrapper">
        ...
        {/* Trending  Products */}
        <div className="trendingprodct_wrapper">
          <h3 className="trendingproduct_heading"> Our Trending Product</h3>
          <div className="trendingproducts_container">
            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Apple Iphone 16</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Cricket Kit</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Bags</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Aparmants</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Mens Hoodies</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Apparmants</p>
            </div>

            <div className="trendingProductsallname">
              <p className="trendingproduct-para">Magazines</p>
            </div>
