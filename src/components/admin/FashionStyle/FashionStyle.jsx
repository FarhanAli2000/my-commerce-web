...
const FashionStyle = () => {
  ...
  useEffect(() => {
    ...
    filterCars(
      ...
      SpecialFeatures,
      Gender,
      Size,Fit,Material,Color,StyleDesign,ClosureType,
      CollarType,SleeveLength,WashType,Features,Season,
    );
  }, [
    selectedCities,
    searchQuery,
    ...
    Connectivity,
    SpecialFeatures,
    Gender,Size,Fit,Material,Color,StyleDesign,ClosureType,
    CollarType,SleeveLength,WashType,Features,Season,
  ]);
  ...
  const filterCars = (
    ...
    if (SleeveLength?.length > 0) {
      filtered = filtered.filter((car) => SleeveLength.includes(car.SleeveLength));
    }
    if (CollarType?.length > 0) {
      filtered = filtered.filter((car) => CollarType.includes(car.CollarType));
    }
    if (ClosureType?.length > 0) {
      filtered = filtered.filter((car) => ClosureType.includes(car.ClosureType));
    }
    if (StyleDesign?.length > 0) {
      filtered = filtered.filter((car) => StyleDesign.includes(car.StyleDesign));
    }
    if (Color?.length > 0) {
              ...
              <hr
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        {["Regular fit", "Slim fit", "Oversized", "Relaxed fit"].map(
                          (engine, index) => (
                            <div
                              key={engine}
                              style={{
              ...
              <hr
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        {["Cotton blend", "Stretch denim", "Raw denim", "Recycled denim"].map(
                          (engine, index) => (
                            <div
                              key={engine}
                              style={{
              ...
              <hr
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        {["Classic", "Distressed", "Vintage", "Ripped","Stone-washed"].map(
                          (engine, index) => (
                            <div
                              key={engine}
                              style={{
              ...
              <hr
                ...
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        {["Standard", "Spread", "Pointed","Shawl collar","No collar"].map(
                          (engine, index) => (
                            <div
                              key={engine}
                              style={{
                            ...
                            >
                              <Form.Check
                                ...
                                // defaultChecked={engine === "V8 Engine"}
                                onChange={() =>
                                  handleCheckboxChangStyleClosureCollarType(engine)
                                }
                              />
                              <span
                                style={{ fontWeight: "bold", color: "#333" }}
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        ...
                        {["Acid-wash", "Stone-wash", "Light-wash","Dark-wash","Black-wash"].map(
                          (engine, index) => (
                            <div
                                          key={engine}
                              style={{
                  ...
                  <Accordion.Body>
                    <div style={{ maxWidth: "300px", margin: "20px" }}>
                      <Form.Group>
                        ...
                        {["Pockets (Chest, Side)", "Patches", "Embroidery","Studded"].map(
                          (engine, index) => (
                            <div
                                          key={engine}
                              style={{
                      ...
                      <Form.Group>
                        ...
                        >
                          <Form.Check
                            ...
                            label="Brand Seller"
                            onChange={(e) =>
                              handleCheckboxChangeSellerType(e, "Brand Seller")
                            }
                            checked={selectedCheckboxSellerType === "Brand Seller"}
                          />
                        ...
                        >
                          <Form.Check
                            ...
                            checked={selectedCheckboxSellerType === "Individuals"}
                          />
                          <span style={{ fontWeight: "bold", color: "#333" }}>
                            12345
                          </span>
