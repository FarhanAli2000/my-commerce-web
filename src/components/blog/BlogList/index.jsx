                      ...
                      <li>
                        <div className="post-author">
                          <div className="post-author-img">
                            <img src={ProfileAvatar13} alt="author" />
                          </div>
                          <Link to="#">
                            <span> Mary </span>
                          </Link>
                  ...
                  <div className="blog-content">
                    ...
                    <ul className="entry-meta meta-item">
                      <li>
                        <div className="post-author">
                          <div className="post-author-img">
                            <img src={ProfileAvatar14} alt="author" />
                          </div>
                          <Link to="#">
                            {" "}
                            <span> Barbara </span>
            ...
            <div className="col-lg-4 theiaStickySidebar">
              <StickyBox>
                <div className="rightsidebar blogsidebar">
                  ...
                  <div className="card">
                    <h4>
                      <img src={category_icon} alt="details-icon" /> Categories
                    </h4>
                    ...
                    <div className="article">
                      <Link to="/blog-details" className="articleimg-1">
                        <ul>
                          ...
                          <li className="date-icon">
                            <i className="fa-solid fa-calendar-days" /> October
                            6, 2022
                          </li>
                        </ul>
                      </Link>
